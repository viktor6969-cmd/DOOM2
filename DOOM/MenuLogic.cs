...
namespace DOOM
{
    ...
    public class MenuItem
    {
        ...
        public RectangleF Bounds { get; set; }  // the texture size (collision)
        public Image Image { get; private set; }  // the menu item texture
        public Action OnSelect { get; private set; } // action on press 
    ...
    public class MenuLogic
    {
        ...
        public MenuLogic(Screen form)
        {
            ...
            _mainMenuItems = new MenuItem[]{
                ...
                new MenuItem("LoadGame", "Assets\\MainMenu\\m_lgttl.png",  () => {_form.GoToGame();_form.LoadGame();}, x, startY + itemGap,350,55), // Start a new game, and load the data from file to Player
        ...
        private void DrawIntroScreen(Graphics g, Size clientSize)
        {
            ...
            // Blinking - Press any botton - write 
            if (_blinkVisible)
            {
        ...
        private void DrawOptions(Graphics g, Size clientSize)
        {
            ...
            g.DrawImage(_mainBackground, 0, 0, clientSize.Width, clientSize.Height);
            g.DrawImage(_doomLogo, 150, 20, 525, 200);
            // Manual item draw (depends on the sound selected option)
        ...
        public void HandleMouseMove(MouseEventArgs e)
        {
            if (_inOptions)
            {
                ...
                if (_optionSelected != prev) _form.Invalidate(); // Redraw only if changed 
                return;
            }
